...
const InventoryStatus = () => {
  ...
  try {
    ...
    const allData = mockInventoryItems;
  ...
  try {
    ...
    const mockImageMap = {
      1: {
        product_image: "/mock-images/product1.jpg",
        pallet_image: "/mock-images/pallet1.jpg"
      },
      2: {
        product_image: "/mock-images/product2.jpg",
        pallet_image: "/mock-images/pallet2.jpg"
      },
      3: {
        product_image: "/mock-images/product3.jpg",
        pallet_image: "/mock-images/pallet3.jpg"
      }
    };

    const data = mockImageMap[productId] || {
      product_image: null,
      pallet_image: null
    };
